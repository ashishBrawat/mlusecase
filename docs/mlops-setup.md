...
git add README.md docs .gitignore machine_learning/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  ...
  [prod workspace admin console](https://adb-5244601605601666.6.azuredatabricks.net#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[machine_learning/databricks.yml](../machine_learning/databricks.yml) file.
...
Follow the instructions in [machine_learning/resources/README.md](../machine_learning/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../machine_learning/resources/README.md)  to propose, test, and deploy
