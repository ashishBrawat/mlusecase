...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``machine_learning/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in machine_learning/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in machine_learning/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-machine_learning-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.machine_learning.machine_learning-model", "Full (Three-Level) Model Name")
