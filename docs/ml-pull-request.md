...
Opening a pull request will trigger a[workflow](../.github/workflows/machine_learning-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-5244601605601666.6.azuredatabricks.net/explore/data/models/staging/machine_learning/machine_learning-model)
* [Prod model in UC](https://adb-5244601605601666.6.azuredatabricks.net/explore/data/models/prod/machine_learning/machine_learning-model)
. 
